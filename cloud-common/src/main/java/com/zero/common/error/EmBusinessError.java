...
public enum EmBusinessError implements CommonError {
    ...
    TOKEN_NOT_EXTINCTED(10011,"token不存在"),
    ...
    PERMISSION_DENIED(90003,"权限不允许"),

    FEHEAD_CA_CERTIFICATE_ILLEGAL(90004,"证书不合法"),
    FEHEAD_CA_CERTIFICATE_GENERATOR_FAIL(90005,"证书生成失败"),

    SERVICE_AUTHENTICATION_ILLEGAL(90006,"用户认证凭据不合法"),
    SERVICE_AUTHENTICATION_INVALID(90007,"用户认证凭据无效");
